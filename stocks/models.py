...
class CompanyHistoricalQuote(TimeStampedModel):
    Date = models.CharField(_('Date'), max_length=255, blank=True, null=False)
    Stock = models.ForeignKey(Stock, on_delete=models.CASCADE, default=None, related_name='CompanyHistoricalQuote_Stock')
    PriceHigh = models.FloatField(_('PriceHigh'), blank=True, null=True)
    PriceLow = models.FloatField(_('PriceLow'), blank=True, null=True)
    PriceOpen = models.FloatField(_('PriceOpen'), blank=True, null=True)
    PriceAverage = models.FloatField(_('PriceAverage'), blank=True, null=True)
    PriceClose = models.FloatField(_('PriceClose'), blank=True, null=True)
    PricePreviousClose = models.FloatField(_('PricePreviousClose'), blank=True, null=True)
    PriceBasic = models.FloatField(_('PriceBasic'), blank=True, null=True)
    TotalVolume = models.FloatField(_('TotalVolume'), blank=True, null=True)
    DealVolume = models.FloatField(_('DealVolume'), blank=True, null=True)
    Volume = models.FloatField(_('Volume'), blank=True, null=True)
    PutthroughVolume = models.FloatField(_('PutthroughVolume'), blank=True, null=True)
    TotalTrade = models.FloatField(_('TotalTrade'), blank=True, null=True)
    TotalValue = models.FloatField(_('TotalValue'), blank=True, null=True)
    PutthroughValue = models.FloatField(_('PutthroughValue'), blank=True, null=True)
    BuyForeignQuantity = models.FloatField(_('BuyForeignQuantity'), blank=True, null=True)
    BuyForeignValue = models.FloatField(_('BuyForeignValue'), blank=True, null=True)
    SellForeignQuantity = models.FloatField(_('SellForeignQuantity'), blank=True, null=True)
    SellForeignValue = models.FloatField(_('SellForeignValue'), blank=True, null=True)
    BuyCount = models.FloatField(_('BuyCount'), blank=True, null=True)
    BuyQuantity = models.FloatField(_('BuyQuantity'), blank=True, null=True)
    SellCount = models.FloatField(_('SellCount'), blank=True, null=True)
    SellQuantity = models.FloatField(_('SellQuantity'), blank=True, null=True)
    BuyAvg = models.FloatField(_('BuyAvg'), blank=True, null=True)
    SellAvg = models.FloatField(_('SellAvg'), blank=True, null=True)
    AdjRatio = models.FloatField(_('AdjRatio'), blank=True, null=True)
    AdjClose = models.FloatField(_('AdjClose'), blank=True, null=True)
    AdjOpen = models.FloatField(_('AdjOpen'), blank=True, null=True)
    AdjHigh = models.FloatField(_('AdjHigh'), blank=True, null=True)
    AdjLow = models.FloatField(_('AdjLow'), blank=True, null=True)
    CurrentForeignRoom = models.FloatField(_('CurrentForeignRoom'), blank=True, null=True)
    Shares = models.FloatField(_('Shares'), blank=True, null=True)
    Exchange = models.FloatField(_('Exchange'), blank=True, null=True)
    PE = models.FloatField(_('PE'), blank=True, null=True)
    PS = models.FloatField(_('PS'), blank=True, null=True)
    PB = models.FloatField(_('PB'), blank=True, null=True)
    MarketCap = models.FloatField(_('MarketCap'), blank=True, null=True)
    LastUpdated = models.CharField(_('LastUpdated'), max_length=255, blank=True, null=True)

    class Meta:
        ordering = ('-created', '-id',)
        verbose_name = _('CompanyHistoricalQuote')
        verbose_name_plural = _('CompanyHistoricalQuote')
...
class DecisiveIndex(TimeStampedModel):
    ...
    LastBuyPoint = models.FloatField(_('LastBuyPoint'), blank=True, null=True)
